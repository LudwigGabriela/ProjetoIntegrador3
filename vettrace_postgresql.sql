...
-- Versão 1.2 - inclui: crmv (formato UFXXXXX), telefone,
--                       data_hora do resíduo, setor de destino
-- ============================================================

-- Garante que o schema está limpo para re-execução em dev
DROP TABLE IF EXISTS validacoes_ciclo     CASCADE;
DROP TABLE IF EXISTS ciclo_kits           CASCADE;
DROP TABLE IF EXISTS ciclos_esterilizacao CASCADE;
DROP TABLE IF EXISTS kits                 CASCADE;
DROP TABLE IF EXISTS autoclaves           CASCADE;
DROP TABLE IF EXISTS descartes            CASCADE;
DROP TABLE IF EXISTS categorias_descarte  CASCADE;
DROP TABLE IF EXISTS retiradas_cadaver    CASCADE;
DROP TABLE IF EXISTS cadaveres            CASCADE;
DROP TABLE IF EXISTS destinos_cadaver     CASCADE;
